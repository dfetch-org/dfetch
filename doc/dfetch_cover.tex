...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, opacity=0.90]
    ...
    {\includegraphics[width=0.23\paperwidth]{dfetch_logo.png}};

  % ------------------------------------------------------------------ %
  %  TOP SECTION: "DFetch" BRAND  (top-left, Poiret One)               %
  % ------------------------------------------------------------------ %
  \node[anchor=north west, text=dfetchCoverLight,
        font={\PoiretOne\fontsize{28}{32}\selectfont},
        inner sep=0pt]
  ...
  % Main title — Poiret One, capitalise D & F
