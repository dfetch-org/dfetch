...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'sphinx.ext.napoleon', 'sphinxarg.ext', 'sphinx.ext.autosectionlabel']
...
latex_documents = [
    (master_doc, 'dfetch.tex', 'Dfetch Documentation',
     'Dfetch', 'manual'),
]
...
man_pages = [
    (master_doc, 'dfetch', 'Dfetch Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dfetch', 'Dfetch Documentation',
     author, 'Dfetch', 'One line description of project.',
     'Miscellaneous'),
]
