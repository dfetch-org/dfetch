...
asciinema rec --overwrite -c "./update-patch-intermediate-demo.sh" ../asciicasts/update-patch-intermediate.cast
asciinema rec --overwrite -c "./replay-patches-demo.sh" ../asciicasts/replay-patches.cast
asciinema rec --overwrite -c "./replay-patches-multi-demo.sh" ../asciicasts/replay-patches-multi.cast
