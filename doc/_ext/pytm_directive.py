...
def _render_seq(seq_str: str) -> str:
    ...
    # plantweb.directive provides ``.. uml::`` and calls plantuml.com —
    # the same mechanism used for all other PlantUML diagrams in the docs.
    lines = [".. uml::", ""]
...
def _render_dfd(dfd_str: str) -> str:
    ...
    # Wrap the GraphViz DOT source in PlantUML @startdot/@enddot so plantweb
    # renders it via plantuml.com — no local ``dot`` binary required.
    lines = [".. uml::", "", "   @startdot"]
