...
def _generate_diagrams(mod: Any, confdir: str = "") -> tuple[str, str, str]:
    seq_str = ""
    dfd_str = ""
    buf = _io.StringIO()
    ...
    return seq_str, dfd_str, seq_img_path
...
def _load_model(model_path: str, confdir: str = "") -> dict:
    ...
    seq_str, dfd_str, seq_img_path = _generate_diagrams(mod, confdir)
