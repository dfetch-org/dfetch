...
class SubProject:
    ...
    def update(
        ...
        Args:
            ...
            eol_preferences_callback: Given a list of paths, returns the line
                ending the superproject requests per path (e.g. from gitattributes).
                The VCS backend applies it natively while fetching.
        """
