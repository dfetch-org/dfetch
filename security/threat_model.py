...
CONTROLS: list[Control] = [
    ...
    Control(
        ...
        status="implemented",
        description=(
            "The release pipeline does generates SLSA provenance attestations and "
            "Sigstore/cosign signatures for the published wheel.  Consumers can "
    ...
    Control(
        ...
        status="implemented",
        description=(
            "A CycloneDX SBOM is generated during after building the wheel. "
            "This machine-readable SBOM is published "
    ...
    Control(
        ...
        status="implemented",
        description=(
            "``ci.yml`` only passes required repository secrets to the test and docs workflows. "
            "So no malicious pull request step in either workflow could exfiltrate secrets."
        ),
    ),
    Control(
        id="C-025",
