...
df13.description = (
    ...
    "SLSA provenance attestations are generated by the release pipeline."
)
df13.protocol = "HTTPS"
df13.controls.isEncrypted = True
df13.controls.usesCodeSigning = False  # no Sigstore/cosign signing on the wheel itself
...
CONTROLS: list[Control] = [
    ...
    Control(
        ...
        threats=["DFT-05"],
        description=(
            "The release pipeline generates SLSA provenance attestations and "
    ...
    Control(
        ...
        description=(
            ...
            "blocked — secret exfiltration via a compromised CI step remains possible."
        ),
    ),
    # ── Gaps ─────────────────────────────────────────────────────────────────
    Control(
